...
#define FLASH_UPDATE_METADATA_SECTOR_COUNT 2u
#define FLASH_UPDATE_METADATA_SIZE_BYTES  (FLASH_UPDATE_METADATA_SECTOR_COUNT * FLASH_SECTOR_SIZE)

#define FLASH_SERVICE_REGION_BASE_OFFSET FLASH_SLOT_B_END_OFFSET
#define FLASH_SERVICE_REGION_END_OFFSET  (0x003FA000u - FLASH_UPDATE_METADATA_SIZE_BYTES)
...
#define FLASH_UPDATE_METADATA_SECTOR_A_OFFSET FLASH_UPDATE_METADATA_OFFSET
#define FLASH_UPDATE_METADATA_SECTOR_B_OFFSET (FLASH_UPDATE_METADATA_SECTOR_A_OFFSET + FLASH_SECTOR_SIZE)
...
static_assert(FLASH_UPDATE_METADATA_SECTOR_COUNT == 2u,
              "Metadata journal currently expects exactly two ping-pong sectors");
static_assert(FLASH_UPDATE_METADATA_SIZE_BYTES == (2u * FLASH_SECTOR_SIZE),
              "Metadata journal size must match two sectors");
static_assert((FLASH_UPDATE_METADATA_OFFSET % FLASH_SECTOR_SIZE) == 0u,
              "Update metadata sector must be sector-aligned");
static_assert(FLASH_UPDATE_METADATA_SECTOR_A_OFFSET == FLASH_UPDATE_METADATA_OFFSET,
              "Metadata sector A must start at metadata base");
static_assert(FLASH_UPDATE_METADATA_SECTOR_B_OFFSET ==
                  (FLASH_UPDATE_METADATA_SECTOR_A_OFFSET + FLASH_SECTOR_SIZE),
              "Metadata sector B must follow sector A immediately");
