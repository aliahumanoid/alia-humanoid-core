/**
 * @file MT6835.h
 * @brief Driver for MT6835 21-bit magnetic encoder
 *
 * This driver provides a complete interface to the MT6835 magnetic encoder chip,
 * including angle reading, configuration, calibration, and EEPROM programming.
 *
 * Features:
 * - 21-bit angular resolution (2,097,152 counts per revolution)
 * - SPI communication (up to 2 MHz)
 * - CRC verification for data integrity
 * - Configurable bandwidth, hysteresis, and rotation direction
 * - ABZ incremental output configuration
 * - Zero position setting and calibration
 * - EEPROM storage for persistent settings
 *
 * @see MT6835 datasheet for register details and timing requirements
 */
...
#define MT6835_CPR 2097152  ///< Counts per revolution (21-bit = 2^21)

// ============================================================================
// STATUS FLAGS
// ============================================================================

#define MT6835_STATUS_OVERSPEED 0x01  ///< Overspeed detected
#define MT6835_STATUS_WEAKFIELD 0x02  ///< Magnetic field too weak
#define MT6835_STATUS_UNDERVOLT 0x04  ///< Supply voltage too low
#define MT6835_CRC_ERROR 0x08         ///< CRC check failed

#define MT6835_WRITE_ACK 0x55  ///< Expected write acknowledgment value

// ============================================================================
// REGISTER ADDRESSES
// ============================================================================

#define MT6835_REG_USERID 0x001  ///< User ID register
...
/// Default SPI settings for MT6835 (1 MHz, MSB first, SPI Mode 3)
static SPISettings MT6835SPISettings(1000000, MT6835_BITORDER, SPI_MODE3);

/**
 * @class MT6835
 * @brief MT6835 21-bit magnetic encoder driver
 *
 * Provides complete control over the MT6835 magnetic encoder including:
 * - Angular position reading with CRC verification
 * - Configuration of bandwidth, hysteresis, rotation direction
 * - ABZ incremental output setup
 * - Zero position calibration
 * - EEPROM programming for persistent settings
 */
class MT6835 {
public:
