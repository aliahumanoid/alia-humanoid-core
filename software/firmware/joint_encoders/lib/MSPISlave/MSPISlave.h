...
class MSPISlaveClass {
public:
  MSPISlaveClass(spi_inst_t *spi, pin_size_t rx, pin_size_t cs, pin_size_t sck, pin_size_t tx);
...
extern MSPISlaveClass SPISlave;
extern MSPISlaveClass SPISlave1;
